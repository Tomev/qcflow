Hyperparameter tuning with QCFlow and child runs - Notebooks
============================================================
...
.. toctree::
    ...
    Hyperparameter tuning with QCFlow <hyperparameter-tuning-with-child-runs.ipynb>
    Parent Child Run Relationships <parent-child-runs.ipynb>
    Plot Logging in QCFlow <logging-plots-in-qcflow.ipynb>

Main Notebook - Hyperparameter tuning using Child Runs in QCFlow
----------------------------------------------------------------
The main notebook of this guide provides a working end-to-end example of performing hyperparameter tuning
with QCFlow. We introduce the concept of child runs as a way to organize and declutter an Experiment's runs
...
- **Using Optuna with QCFlow** to familiarize yourself with a powerful state-of-the-art tuning optimization tool.
...
-------------------------------------------------------
This notebook explores the benefits and usage of parent and child runs within QCFlow. In it, we explore
...
Supplementary Notebook - Logging Plots in QCFlow
------------------------------------------------
This notebook shows best practices around logging important plots associated with the machine learning lifecycle.
From data investigation and reporting plots to model evaluation plots, we delve into the native support that QCFlow has
...
.. note::
    ...
    organized within your logged QCFlow runs to ensure that auditing and navigation is easier for reviewers.

.. raw:: html

    <a href="logging-plots-in-qcflow.html" class="download-btn">View the Notebook</a>
...
.. raw:: html
    ...
    <a href="https://raw.githubusercontent.com/qcflow/qcflow/master/docs/source/traditional-ml/hyperparameter-tuning-with-child-runs/notebooks/hyperparameter-tuning-with-child-runs.ipynb" class="notebook-download-btn">Download the main notebook</a><br/>
    <a href="https://raw.githubusercontent.com/qcflow/qcflow/master/docs/source/traditional-ml/hyperparameter-tuning-with-child-runs/notebooks/parent-child-runs.ipynb" class="notebook-download-btn">Download the Parent-Child Runs notebook</a><br/>
    <a href="https://raw.githubusercontent.com/qcflow/qcflow/master/docs/source/traditional-ml/hyperparameter-tuning-with-child-runs/notebooks/logging-plots-in-qcflow.ipynb" class="notebook-download-btn">Download the Plot Logging in QCFlow notebook</a><br/>
