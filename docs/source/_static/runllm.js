document.addEventListener("DOMContentLoaded", function () {
    ...
    script.setAttribute("runllm-name", "QCFlow");
    script.setAttribute("runllm-position", "BOTTOM_RIGHT");
    script.setAttribute("runllm-assistant-id", "116");
    script.setAttribute("runllm-theme-color", "#008ED9");
    script.setAttribute("runllm-brand-logo", "https://qcflow.org/img/qcflow-favicon.ico");
    script.setAttribute("runllm-community-type", "slack");
    script.setAttribute("runllm-community-url", "https://qcflow.org/slack");
