#
# QCFlow documentation build configuration file, created by
...
project = "QCFlow"
copyright = "QCFlow Project, a Series of LF Projects, LLC. All rights reserved"
author = "QCFlow"
...
version = qcflow.version.VERSION
# The full version, including alpha/beta/rc tags.
release = qcflow.version.VERSION
...
latex_documents = [
    (master_doc, "QCFlow.tex", "QCFlow Documentation", "Databricks", "manual"),
]
...
man_pages = [(master_doc, "QCFlow", "QCFlow Documentation", [author], 1)]
...
nitpicky = True
nitpick_ignore = [
    # Ignore a missing reference in `qcflow/store/entities/paged_list.py`
    ("py:class", "T"),
    ...
    ("py:class", "qcflow.deployments.base.BaseDeploymentClient"),
    ("py:class", "Endpoint"),
    ("py:class", "qcflow.types.schema.DataType"),
    ("py:class", "qcflow.types.schema.ColSpec"),
    ("py:class", "qcflow.types.schema.TensorSpec"),
    ("py:class", "qcflow.types.schema.Schema"),
    ("py:class", "qcflow.types.schema.ParamSchema"),
    ("py:class", "qcflow.types.schema.ParamSpec"),
    ...
    ("py:class", "qcflow.entities.trace_status.TraceStatus"),
    ("py:class", "ModelSignature"),
    ("py:class", "ModelInputExample"),
    ("py:class", "abc.ABC"),
    ("py:class", "Model"),
    ("py:class", "qcflow.models.model.Model"),
    ("py:class", "qcflow.models.signature.ModelSignature"),
    ("py:class", "qcflow.models.resources.Resource"),
    ("py:class", "qcflow.models.resources.ResourceType"),
    ("py:class", "qcflow.models.dependencies_schemas.set_retriever_schema"),
    ("py:class", "qcflow.metrics.genai.base.EvaluationExample"),
    ...
    # for docstring of qcflow.models.update_model_requirements
    ("py:class", "add"),
    ("py:class", "remove"),
...
def _get_reference_map():
    ...
    def start_run(...) -> ActiveRun:
        # ActiveRun is defined in `qcflow/tracking/fluent.py`
        ...
    ```

    For this code, Sphinx tries to create a link for `ActiveRun` using
    `qcflow.tracking.fluent.ActiveRun` as a reference target, but the module
    `qcflow.tracking.fluent` is undocumented, so Sphinx raises this warning:
    `WARNING: py:class reference target not found: qcflow.tracking.fluent.ActiveRun`.
    As a workaround, replace `qcflow.tracking.fluent.ActiveRun` with `qcflow.ActiveRun`.
    """
    ref_map = {
        # < Invalid reference >: < valid reference >
        "qcflow.tracking.fluent.ActiveRun": "qcflow.ActiveRun",
        "qcflow.store.entities.paged_list.PagedList": "qcflow.store.entities.PagedList",
    }

    # Tracking entities
    for entity_name in qcflow.entities.__all__:
        entity_cls = getattr(qcflow.entities, entity_name)
        invalid_ref = entity_cls.__module__ + "." + entity_name
        valid_ref = f"qcflow.entities.{entity_name}"
        ref_map[invalid_ref] = valid_ref

    # Model registry entities
    for entity_name in qcflow.entities.model_registry.__all__:
        entity_cls = getattr(qcflow.entities.model_registry, entity_name)
        invalid_ref = entity_cls.__module__ + "." + entity_name
        valid_ref = f"qcflow.entities.model_registry.{entity_name}"
        ref_map[invalid_ref] = valid_ref
