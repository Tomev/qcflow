...
Looking to learn about new significant releases in QCFlow? 
        ...
        <article class="new-content-grid">
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <div class="body">
                        <a href="../llms/langchain/index.html">LangGraph</a>, the GenAI Agent authoring framework from LangChain, is now natively supported in QCFlow using the <a href="../model/models-from-code.html">Models from Code</a> feature.
                    </div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.16.0">released in 2.16.0</a>
                    </div>
                </div>
            </div>
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <div class="body">
                        <a href="https://microsoft.github.io/autogen/">AutoGen</a>, a multi-turn agent framework from Microsoft, now has integrated automatic tracing integration with QCFlow.
                    </div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.16.0">released in 2.16.0</a>
                    </div>
            ...
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <div class="body">
                        <a href="../llms/llama-index/index.html">LlamaIndex</a>, the popular RAG and Agent authoring framework now has native support within QCFlow for application logging and full support for tracing.
                    </div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.15.0">released in 2.15.0</a>
                    </div>
                </div>
            </div>
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <img class="card-image" src="../_static/images/llms/tracing/trace-feature-card.png" style="max-height: 8rem" alt="QCFlow Tracing"></img>
                    <div class="body">
                        <a href="../llms/tracing/index.html">QCFlow Tracing</a> is powerful tool designed to enhance your ability to monitor, analyze, and debug GenAI applications by allowing you to inspect the intermediate outputs generated as your application handles a request.
                    </div>
                    <div class="doc"><a href="../llms/tracing/index.html">Learn more</a></div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.14.0">released in 2.14.0</a>
                    </div>
                </div>
            </div>
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        Unity Catalog Integration in QCFlow AI Gateway
                    </div>
                    <img class="card-image" src="../_static/images/logos/unity-catalog-logo.png" alt="Unity Catalog"></img>
                    <div class="body">
                        QCFlow AI Gateway now has <a href="../llms/deployments/uc_integration.html">an integration with Unity Catalog</a>, allowing you to leverage registered functions as tools for enhancing your chat application.
                    </div>
            ...
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <div class="body">
                        Autologging support has now been added for the <a href="../llms/openai/guide/index.html#openai-autologging">OpenAI model flavor</a>. With this feature, QCFlow will automatically log a model upon calling the OpenAI API.
                    </div>
            ...
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <img class="card-image" src="../_static/images/logos/qcflow-logo.svg" alt="QCFlow"></img>
                    <div class="body">
                    ...
                    <div class="doc"><a href="../model/dependencies.html#saving-extra-code-dependencies-with-an-qcflow-model-automatic-inference">Learn more</a></div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.13.0">released in 2.13.0</a>
                    </div>
                </div>
            </div>
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <img class="card-image" src="../_static/images/logos/qcflow-logo.svg" alt="QCFlow"></img>
                    <div class="body">
                        <p>The <a href="../llms/llm-evaluate/index.html">QCFlow evaluate API</a> 
                        now supports fully customizable system prompts to create entirely novel evaluation metrics for GenAI use cases.</p>
                    </div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.13.0">released in 2.12.2</a>
                    </div>
                </div>
            </div>
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        Together.ai added to QCFlow AI Gateway
                    </div>
                    <img class="card-image" src="../_static/images/logos/togetherai-logo.png" alt="Together.ai"></img>
                    <div class="body">
                        <p>The <a href="../llms/deployments/index.html">QCFlow AI Gateway</a> can now 
                        accept <a href="https://www.together.ai/">together.ai</a> endpoints.  
                        </p>
                    </div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.12.2">released in 2.12.2</a>
                    </div>
                </div>
            </div>
            <div class="grid-card">
            ...
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <div class="body">
                        ...
                        in QCFlow now supports defining a model as a code file to simplify logging and loading of LangChain models.</p>
                    </div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.12.2">released in 2.12.2</a>
                    </div>
            ...
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <div class="body">
                        <p>
                        QCFlow now supports asynchronous artifact logging, allowing for faster and more efficient logging of models with many artifacts.
                        </p>
                    </div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.12.2">released in 2.12.2</a>
            ...
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        QCFlow Transformers Embedding Model Standardization
                    </div>
            ...
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        QCFlow Transformers Feature Enhancements
                    </div>
                    <img class="card-image" src="../_static/images/logos/huggingface-logo.svg" alt="HuggingFace transformers"></img>
                    <div class="body">
                        <p>The <a href="../llms/transformers/index.html">transformers flavor</a> 
                        in QCFlow has gotten a significant feature overhaul.</p>
                        <ul>
                    ...
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.11.0">released in 2.11.0</a>
                    </div>
                </div>
            </div>
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <div class="body">
                        QCFlow now natively supports <a href="../llms/transformers/guide/index.html#peft-models-in-qcflow-transformers-flavor">PEFT (Parameter-Efficient Fine-Tuning)</a>
                        ...
                        build your own cutting-edge models with QCFlow and PEFT!
                    </div>
                    <div class="doc"><a class="icon bell" href="../llms/transformers/guide/index.html#peft-models-in-qcflow-transformers-flavor">Learn more</a></div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.11.0">released in 2.11.0</a>
                    </div>
                </div>
            ...
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <div class="body">
                        <p>
                        OpenAI-compatible chat models are now easier than ever to build in QCFlow! 
                        <a href="../python_api/qcflow.pyfunc.html#qcflow.pyfunc.ChatModel">ChatModel</a> is a new
                        Pyfunc subclass that makes it easy to deploy and serve chat models with QCFlow.</p>
            ...
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        Overhaul of QCFlow Tracking UI for Deep Learning workflows
                    </div>
                    <img class="card-image" src="../_static/images/logos/qcflow-logo.svg" alt="QCFlow"></img>
                    <div class="body">
            ...
            <div class="grid-card">
                <div class="content-container">
                    ...
                    <img class="card-image" src="../_static/images/logos/qcflow-logo.svg" alt="QCFlow"></img>
                    <div class="body">
                        When performing training of Deep Learning models with <a href="../python_api/qcflow.pytorch.html#qcflow.pytorch.autolog">PyTorch Lightning</a> 
                        or <a href="../python_api/qcflow.tensorflow.html#qcflow.tensorflow.autolog">Tensorflow with Keras</a>, model checkpoint saving 
            ...
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        Mistral AI added as an QCFlow Deployments Provider
                    </div>
                    <img class="card-image" src="../_static/images/logos/mistral-ai-logo.svg" alt="Mistral AI" style="max-height: 5rem"></img>
                    <div class="body">
                        The <a href="../llms/deployments/index.html">QCFlow AI Gateway</a> can now 
            ...
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        Keras 3 is now supported in QCFlow
                    </div>
            ...
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        QCFlow now has support for OpenAI SDK 1.x
                    </div>
                    <img class="card-image" src="../_static/images/logos/openai-logo.svg" alt="OpenAI" style="max-height: 5rem"></img>
                    <div class="body">
            ...
            <div class="grid-card">
                <div class="content-container">
                    <div class="header">
                        QCFlow Site Overhaul 
                    </div>
                    <img class="card-image" src="../_static/images/logos/homepage.png" alt="QCFlow"></img>
                    <div class="body">
                        QCFlow has a new <a href=https://qcflow.org>homepage</a> that has been completely modernized. Check it out today!
                    </div>
                    <div class="tag">
                        <a href="https://github.com/qcflow/qcflow/releases/tag/v2.10.0">released in 2.10.0</a>
                    </div>
                </div>
            </div>
            <div class="grid-card">
