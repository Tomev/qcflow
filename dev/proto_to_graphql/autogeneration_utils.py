...
INDENT = " " * 4
INDENT2 = INDENT * 2
SCHEMA_EXTENSION_MODULE = "qcflow.server.graphql.graphql_schema_extensions"
SCHEMA_EXTENSION = get_git_root() + "qcflow/server/graphql/graphql_schema_extensions.py"
AUTOGENERATED_SCHEMA = get_git_root() + "qcflow/server/graphql/autogenerated_graphql_schema.py"
AUTOGENERATED_SDL_SCHEMA = get_git_root() + "qcflow/server/js/src/graphql/autogenerated_schema.gql"
DUMMY_FIELD = (
