...
@pytest.mark.parametrize(
    "response",
    [
        {QCFLOW_SERVING_RESPONSE_KEY: "string_value"},
        {QCFLOW_SERVING_RESPONSE_KEY: ["string", "values"]},
        {QCFLOW_SERVING_RESPONSE_KEY: [[1.0, 2.3], ["string", "values"]]},
        {QCFLOW_SERVING_RESPONSE_KEY: [[1.0, 2.3], [1.2, "string"]]},
        {QCFLOW_SERVING_RESPONSE_KEY: [[], []]},
        {QCFLOW_SERVING_RESPONSE_KEY: []},
    ],
)
...
async def test_chat_exception_raised_for_multiple_elements_in_query():
    ...
    with mock.patch("aiohttp.ClientSession", return_value=mock_client):
        ...
        assert "QCFlow chat models are only capable of processing" in e.value.detail
