...
class SimpleModel(qcflow.pyfunc.PythonModel):
...
def test_downstream_notebook_job_lineage(
    ...
    with (
        ...
        mock.patch(
            "qcflow.utils.databricks_utils.is_in_databricks_runtime",
            return_value=is_in_notebook or is_in_job,
        ),
        mock.patch(
            "qcflow.utils.databricks_utils.is_in_databricks_job",
        ...
        mock.patch(
            "qcflow.utils.databricks_utils.get_job_id",
            return_value=job_id,
        ),
        mock.patch("qcflow.get_registry_uri", return_value="databricks-uc"),
        mock.patch.object(
            UnityCatalogModelsArtifactRepository,
        ...
        mock.patch(
            "qcflow.utils._unity_catalog_utils._get_artifact_repo_from_storage_info",
        ...
        qcflow.pyfunc.save_model(path=model_dir, python_model=SimpleModel())
        qcflow.pyfunc.load_model(model_uri)
