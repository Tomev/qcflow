...
# Copied from https://github.com/qcflow/qcflow/blob/v0.9.1/qcflow/store/dbmodels/models.py, with
# modifications to substitute constants from QCFlow with hard-coded values (e.g. replacing
