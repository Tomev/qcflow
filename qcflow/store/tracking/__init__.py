"""
An QCFlow tracking server has two properties related to how data is stored: *backend store* to
...
# overridden by specifying an override to `--default-artifact-root` for the QCFlow tracking server.
...
DEFAULT_ARTIFACTS_URI = "qcflow-artifacts:/"
