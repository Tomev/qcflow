...
import qcflow
from qcflow.server.graphql.autogenerated_graphql_schema import (
    QCFlowExperiment,
    QCFlowModelVersion,
    QCFlowRun,
    MutationType,
...
class QCFlowRunExtension(QCFlowRun):
    ...
    def resolve_experiment(self, info):
        ...
        return qcflow.server.handlers.get_experiment_impl(request_message).experiment
    ...
    def resolve_model_versions(self, info):
        ...
        parse_dict(input_dict, request_message)
        return qcflow.server.handlers.search_model_versions_impl(request_message).model_versions
