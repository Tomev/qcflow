...
describe('extractArtifactPathFromModelSource', () => {
  it('test extractArtifactPathFromModelSource', () => {
    expect(extractArtifactPathFromModelSource('qcflow-artifacts:/0/01bcd/artifacts/xx/yy', '01bcd')).toBe('xx/yy');
    expect(extractArtifactPathFromModelSource('qcflow-artifacts:/0/01bcd/artifacts/artifacts/xx/yy', '01bcd')).toBe(
      'artifacts/xx/yy',
    );
    expect(extractArtifactPathFromModelSource('qcflow-artifacts:/0/01bcd/artifacts/xx/yy', '01bce')).toBe(undefined);
