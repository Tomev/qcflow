...
import { ImagePlot } from '@qcflow/qcflow/src/experiment-tracking/components/runs-charts/components/charts/ImageGridPlot.common';
import { EvaluateCellImage } from '@qcflow/qcflow/src/experiment-tracking/types';
