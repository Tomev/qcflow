      ...
      <ConfirmModal
        ...
        helpText={
          <div>
            ...
            {/* @ts-expect-error TS(4111): Property 'QCFLOW_SHOW_GDPR_PURGING_MESSAGES' comes from a... Remove this comment to see the full error message */}
            {process.env.QCFLOW_SHOW_GDPR_PURGING_MESSAGES === 'true' ? (
              <p>
