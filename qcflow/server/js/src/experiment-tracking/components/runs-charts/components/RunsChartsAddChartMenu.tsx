  ...
  return (
    <DropdownMenu.Root modal={false}>
      <DropdownMenu.Trigger asChild>
        <Button
          componentId="codegen_qcflow_app_src_experiment-tracking_components_runs-compare_runscompareaddchartmenu.tsx_19"
      ...
      <DropdownMenu.Content align="end">
        {isChartTypeSupported(RunsChartType.BAR) && (
          <DropdownMenu.Item
            componentId="codegen_qcflow_app_src_experiment-tracking_components_runs-charts_components_runschartsaddchartmenu.tsx_42"
        ...
        {isChartTypeSupported(RunsChartType.LINE) && (
          <DropdownMenu.Item
            componentId="codegen_qcflow_app_src_experiment-tracking_components_runs-charts_components_runschartsaddchartmenu.tsx_56"
        ...
        {isChartTypeSupported(RunsChartType.PARALLEL) && (
          <DropdownMenu.Item
            componentId="codegen_qcflow_app_src_experiment-tracking_components_runs-charts_components_runschartsaddchartmenu.tsx_70"
        ...
        {isChartTypeSupported(RunsChartType.SCATTER) && (
          <DropdownMenu.Item
            componentId="codegen_qcflow_app_src_experiment-tracking_components_runs-charts_components_runschartsaddchartmenu.tsx_84"
        ...
        {isChartTypeSupported(RunsChartType.CONTOUR) && (
          <DropdownMenu.Item
            componentId="codegen_qcflow_app_src_experiment-tracking_components_runs-charts_components_runschartsaddchartmenu.tsx_98"
        ...
        {shouldEnableDifferenceViewCharts() && isChartTypeSupported(RunsChartType.DIFFERENCE) && (
          <DropdownMenu.Item
            componentId="codegen_qcflow_app_src_experiment-tracking_components_runs-charts_components_runschartsaddchartmenu.tsx_112"
        ...
        {shouldEnableImageGridCharts() && isChartTypeSupported(RunsChartType.IMAGE) && (
          <DropdownMenu.Item
            componentId="codegen_qcflow_app_src_experiment-tracking_components_runs-charts_components_runschartsaddchartmenu.tsx_126"
