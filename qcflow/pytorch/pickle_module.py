...
serialization.py#L192). It is included as a distinct module from :mod:`qcflow.pytorch` to avoid
polluting the namespace with wildcard imports.

Calling ``torch.save(..., pickle_module=qcflow.pytorch.pickle_module)`` will persist PyTorch model
