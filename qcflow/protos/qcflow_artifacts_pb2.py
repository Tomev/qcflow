...
if Version(google.protobuf.__version__).major >= 5:
  ...
  DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x16qcflow_artifacts.proto\x12\x10qcflow.artifacts\x1a\x15scalapb/scalapb.proto\x1a\x10\x64\x61tabricks.proto\"\x1e\n\x10\x44ownloadArtifact\x1a\n\n\x08Response\"\x1c\n\x0eUploadArtifact\x1a\n\n\x08Response\"T\n\rListArtifacts\x12\x0c\n\x04path\x18\x01 \x01(\t\x1a\x35\n\x08Response\x12)\n\x05\x66iles\x18\x01 \x03(\x0b\x32\x1a.qcflow.artifacts.FileInfo\"\x1c\n\x0e\x44\x65leteArtifact\x1a\n\n\x08Response\";\n\x08\x46ileInfo\x12\x0c\n\x04path\x18\x01 \x01(\t\x12\x0e\n\x06is_dir\x18\x02 \x01(\x08\x12\x11\n\tfile_size\x18\x03 \x01(\x03\"\x99\x01\n\x15\x43reateMultipartUpload\x12\x0c\n\x04path\x18\x01 \x01(\t\x12\x11\n\tnum_parts\x18\x02 \x01(\x03\x1a_\n\x08Response\x12\x11\n\tupload_id\x18\x01 \x01(\t\x12@\n\x0b\x63redentials\x18\x02 \x03(\x0b\x32+.qcflow.artifacts.MultipartUploadCredential\"|\n\x17\x43ompleteMultipartUpload\x12\x0c\n\x04path\x18\x01 \x01(\t\x12\x11\n\tupload_id\x18\x02 \x01(\t\x12\x34\n\x05parts\x18\x03 \x03(\x0b\x32%.qcflow.artifacts.MultipartUploadPart\x1a\n\n\x08Response\"C\n\x14\x41\x62ortMultipartUpload\x12\x0c\n\x04path\x18\x01 \x01(\t\x12\x11\n\tupload_id\x18\x02 \x01(\t\x1a\n\n\x08Response\"\xb8\x01\n\x19MultipartUploadCredential\x12\x0b\n\x03url\x18\x01 \x01(\t\x12\x13\n\x0bpart_number\x18\x02 \x01(\x03\x12I\n\x07headers\x18\x03 \x03(\x0b\x32\x38.qcflow.artifacts.MultipartUploadCredential.HeadersEntry\x1a.\n\x0cHeadersEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t:\x02\x38\x01\"E\n\x13MultipartUploadPart\x12\x13\n\x0bpart_number\x18\x01 \x01(\x03\x12\x0c\n\x04\x65tag\x18\x02 \x01(\t\x12\x0b\n\x03url\x18\x03 \x01(\t2\x99\x0b\n\x16QCFlowArtifactsService\x12\xbd\x01\n\x10\x64ownloadArtifact\x12\".qcflow.artifacts.DownloadArtifact\x1a+.qcflow.artifacts.DownloadArtifact.Response\"X\xf2\x86\x19T\n=\n\x03GET\x12\x30/qcflow-artifacts/artifacts/<path:artifact_path>\x1a\x04\x08\x02\x10\x00\x10\x01*\x11\x44ownload Artifact\x12\xb5\x01\n\x0euploadArtifact\x12 .qcflow.artifacts.UploadArtifact\x1a).qcflow.artifacts.UploadArtifact.Response\"V\xf2\x86\x19R\n=\n\x03PUT\x12\x30/qcflow-artifacts/artifacts/<path:artifact_path>\x1a\x04\x08\x02\x10\x00\x10\x01*\x0fUpload Artifact\x12\x9c\x01\n\rlistArtifacts\x12\x1f.qcflow.artifacts.ListArtifacts\x1a(.qcflow.artifacts.ListArtifacts.Response\"@\xf2\x86\x19<\n(\n\x03GET\x12\x1b/qcflow-artifacts/artifacts\x1a\x04\x08\x02\x10\x00\x10\x01*\x0eList Artifacts\x12\xb9\x01\n\x0e\x64\x65leteArtifact\x12 .qcflow.artifacts.DeleteArtifact\x1a).qcflow.artifacts.DeleteArtifact.Response\"Z\xf2\x86\x19V\n@\n\x06\x44\x45LETE\x12\x30/qcflow-artifacts/artifacts/<path:artifact_path>\x1a\x04\x08\x02\x10\x00\x10\x01*\x10\x44\x65lete Artifacts\x12\xe0\x01\n\x15\x63reateMultipartUpload\x12\'.qcflow.artifacts.CreateMultipartUpload\x1a\x30.qcflow.artifacts.CreateMultipartUpload.Response\"l\xf2\x86\x19h\n?\n\x04POST\x12\x31/qcflow-artifacts/mpu/create/<path:artifact_path>\x1a\x04\x08\x02\x10\x00\x10\x01*#Create an Artifact Multipart Upload\x12\xea\x01\n\x17\x63ompleteMultipartUpload\x12).qcflow.artifacts.CompleteMultipartUpload\x1a\x32.qcflow.artifacts.CompleteMultipartUpload.Response\"p\xf2\x86\x19l\nA\n\x04POST\x12\x33/qcflow-artifacts/mpu/complete/<path:artifact_path>\x1a\x04\x08\x02\x10\x00\x10\x01*%Complete an Artifact Multipart Upload\x12\xdb\x01\n\x14\x61\x62ortMultipartUpload\x12&.qcflow.artifacts.AbortMultipartUpload\x1a/.qcflow.artifacts.AbortMultipartUpload.Response\"j\xf2\x86\x19\x66\n>\n\x04POST\x12\x30/qcflow-artifacts/mpu/abort/<path:artifact_path>\x1a\x04\x08\x02\x10\x00\x10\x01*\"Abort an Artifact Multipart UploadB\x1e\n\x14org.qcflow.api.proto\x90\x01\x01\xe2?\x02\x10\x01')

  _globals = globals()
  _builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
  _builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'qcflow_artifacts_pb2', _globals)
  if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['downloadArtifact']._loaded_options = None
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['downloadArtifact']._serialized_options = b'\362\206\031T\n=\n\003GET\0220/qcflow-artifacts/artifacts/<path:artifact_path>\032\004\010\002\020\000\020\001*\021Download Artifact'
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['uploadArtifact']._loaded_options = None
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['uploadArtifact']._serialized_options = b'\362\206\031R\n=\n\003PUT\0220/qcflow-artifacts/artifacts/<path:artifact_path>\032\004\010\002\020\000\020\001*\017Upload Artifact'
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['listArtifacts']._loaded_options = None
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['listArtifacts']._serialized_options = b'\362\206\031<\n(\n\003GET\022\033/qcflow-artifacts/artifacts\032\004\010\002\020\000\020\001*\016List Artifacts'
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['deleteArtifact']._loaded_options = None
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['deleteArtifact']._serialized_options = b'\362\206\031V\n@\n\006DELETE\0220/qcflow-artifacts/artifacts/<path:artifact_path>\032\004\010\002\020\000\020\001*\020Delete Artifacts'
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['createMultipartUpload']._loaded_options = None
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['createMultipartUpload']._serialized_options = b'\362\206\031h\n?\n\004POST\0221/qcflow-artifacts/mpu/create/<path:artifact_path>\032\004\010\002\020\000\020\001*#Create an Artifact Multipart Upload'
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['completeMultipartUpload']._loaded_options = None
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['completeMultipartUpload']._serialized_options = b'\362\206\031l\nA\n\004POST\0223/qcflow-artifacts/mpu/complete/<path:artifact_path>\032\004\010\002\020\000\020\001*%Complete an Artifact Multipart Upload'
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['abortMultipartUpload']._loaded_options = None
    _globals['_QCFLOWARTIFACTSSERVICE'].methods_by_name['abortMultipartUpload']._serialized_options = b'\362\206\031f\n>\n\004POST\0220/qcflow-artifacts/mpu/abort/<path:artifact_path>\032\004\010\002\020\000\020\001*\"Abort an Artifact Multipart Upload'
    ...
    _globals['_QCFLOWARTIFACTSSERVICE']._serialized_start=934
    _globals['_QCFLOWARTIFACTSSERVICE']._serialized_end=2367
  _builder.BuildServices(DESCRIPTOR, 'qcflow_artifacts_pb2', _globals)
  ...
  DownloadArtifact = _reflection.GeneratedProtocolMessageType('DownloadArtifact', (_message.Message,), {
    ...
    'Response' : _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {
      ...
      '__module__' : 'qcflow_artifacts_pb2'
  ...
  MultipartUploadCredential = _reflection.GeneratedProtocolMessageType('MultipartUploadCredential', (_message.Message,), {
    ...
    'HeadersEntry' : _reflection.GeneratedProtocolMessageType('HeadersEntry', (_message.Message,), {
      ...
      '__module__' : 'qcflow_artifacts_pb2'
      # @@protoc_insertion_point(class_scope:qcflow.artifacts.MultipartUploadCredential.HeadersEntry)
      })
    ,
  ...
  _QCFLOWARTIFACTSSERVICE = DESCRIPTOR.services_by_name['QCFlowArtifactsService']
  if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QCFLOWARTIFACTSSERVICE.methods_by_name['downloadArtifact']._options = None
    _QCFLOWARTIFACTSSERVICE.methods_by_name['downloadArtifact']._serialized_options = b'\362\206\031T\n=\n\003GET\0220/qcflow-artifacts/artifacts/<path:artifact_path>\032\004\010\002\020\000\020\001*\021Download Artifact'
    _QCFLOWARTIFACTSSERVICE.methods_by_name['uploadArtifact']._options = None
    _QCFLOWARTIFACTSSERVICE.methods_by_name['uploadArtifact']._serialized_options = b'\362\206\031R\n=\n\003PUT\0220/qcflow-artifacts/artifacts/<path:artifact_path>\032\004\010\002\020\000\020\001*\017Upload Artifact'
    _QCFLOWARTIFACTSSERVICE.methods_by_name['listArtifacts']._options = None
    _QCFLOWARTIFACTSSERVICE.methods_by_name['listArtifacts']._serialized_options = b'\362\206\031<\n(\n\003GET\022\033/qcflow-artifacts/artifacts\032\004\010\002\020\000\020\001*\016List Artifacts'
    _QCFLOWARTIFACTSSERVICE.methods_by_name['deleteArtifact']._options = None
    _QCFLOWARTIFACTSSERVICE.methods_by_name['deleteArtifact']._serialized_options = b'\362\206\031V\n@\n\006DELETE\0220/qcflow-artifacts/artifacts/<path:artifact_path>\032\004\010\002\020\000\020\001*\020Delete Artifacts'
    _QCFLOWARTIFACTSSERVICE.methods_by_name['createMultipartUpload']._options = None
    _QCFLOWARTIFACTSSERVICE.methods_by_name['createMultipartUpload']._serialized_options = b'\362\206\031h\n?\n\004POST\0221/qcflow-artifacts/mpu/create/<path:artifact_path>\032\004\010\002\020\000\020\001*#Create an Artifact Multipart Upload'
    _QCFLOWARTIFACTSSERVICE.methods_by_name['completeMultipartUpload']._options = None
    _QCFLOWARTIFACTSSERVICE.methods_by_name['completeMultipartUpload']._serialized_options = b'\362\206\031l\nA\n\004POST\0223/qcflow-artifacts/mpu/complete/<path:artifact_path>\032\004\010\002\020\000\020\001*%Complete an Artifact Multipart Upload'
    _QCFLOWARTIFACTSSERVICE.methods_by_name['abortMultipartUpload']._options = None
    _QCFLOWARTIFACTSSERVICE.methods_by_name['abortMultipartUpload']._serialized_options = b'\362\206\031f\n>\n\004POST\0220/qcflow-artifacts/mpu/abort/<path:artifact_path>\032\004\010\002\020\000\020\001*\"Abort an Artifact Multipart Upload'
    ...
    _QCFLOWARTIFACTSSERVICE._serialized_start=934
    _QCFLOWARTIFACTSSERVICE._serialized_end=2367
  QCFlowArtifactsService = service_reflection.GeneratedServiceType('QCFlowArtifactsService', (_service.Service,), dict(
    DESCRIPTOR = _QCFLOWARTIFACTSSERVICE,
    __module__ = 'qcflow_artifacts_pb2'
    ))

  QCFlowArtifactsService_Stub = service_reflection.GeneratedServiceStubType('QCFlowArtifactsService_Stub', (QCFlowArtifactsService,), dict(
    DESCRIPTOR = _QCFLOWARTIFACTSSERVICE,
    __module__ = 'qcflow_artifacts_pb2'
    ))
