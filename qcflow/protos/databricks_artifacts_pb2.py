...
if Version(google.protobuf.__version__).major >= 5:
  ...
  _DATABRICKSQCFLOWARTIFACTSSERVICE = DESCRIPTOR.services_by_name['DatabricksQCFlowArtifactsService']
  ...
  DatabricksQCFlowArtifactsService = service_reflection.GeneratedServiceType('DatabricksQCFlowArtifactsService', (_service.Service,), dict(
    DESCRIPTOR = _DATABRICKSQCFLOWARTIFACTSSERVICE,
    __module__ = 'databricks_artifacts_pb2'
    ))

  DatabricksQCFlowArtifactsService_Stub = service_reflection.GeneratedServiceStubType('DatabricksQCFlowArtifactsService_Stub', (DatabricksQCFlowArtifactsService,), dict(
    DESCRIPTOR = _DATABRICKSQCFLOWARTIFACTSSERVICE,
    __module__ = 'databricks_artifacts_pb2'
    ))
